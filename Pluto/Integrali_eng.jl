...
# Package SymPyPythonCallSymPy for symbolic computation, package Plots for
# plotting
using SymPyPythonCall, Plots

# ╔═╡ efc1cf20-8276-11eb-39ba-bd62a4342e68
md"
# Integrals

Examples of integrals, definite integrals and areas
"

# ╔═╡ d52c1d09-9bee-4359-8e2c-a969a2f32ea3
# This command lists all parts of the package, mostly functions
# varinfo(SymPyPythonCall)

# ╔═╡ fbe23817-356c-466c-96a5-e18f0f0ac906
md"
...
begin
	# Let us compute several integrals
	x=symbols("x", real=true)
	integrate(log(x))
end

# ╔═╡ ea5df667-88e9-4a4f-9c86-78d4458fddae
integrate(x*exp(x))

# ╔═╡ 4064603e-693b-4a4d-8f43-c5722018d690
integrate(x*exp(-x^2))
...
# ╔═╡ d440af7e-d63a-41c7-9b6a-3722ffd22148
integrate(exp(x)*sin(x))

# ╔═╡ ace8f150-05ad-4a08-b89b-36b6d7ddac51
md"
### Problem (difficult)
Compute

$$
\int x\cdot \sin x\cdot e^x dx.$$
"

# ╔═╡ 4a29d9d5-c36e-4f90-9748-60b253e91626
md"
## Recursive formulas
"
...
# Longer recursive formula
integrate(1/(1+x^2)^13)

# ╔═╡ 071abcd0-5496-4453-b252-24124977bc3d
md"
## Derivatives
"
...
# ╔═╡ 736c5d30-281c-4e9d-bdbe-879da774c190
md"
## Rational functions
"

# ╔═╡ ac8513bf-6506-4698-b85d-4d92fced705a
integrate((x^3+2x^2+3x-6)/((x+1)(x^2+2x+3)^2))

# ╔═╡ e75c8a66-50da-462b-9587-0928b79e2374
md"
## Rational functions of trigonometric functions

__Universal trigonometric substitution__

$$\begin{aligned}
t&=\tan\frac{x}{2}, \quad x=2\mathop{\mathrm{atan}}(t),\quad  dx=\displaystyle\frac{2}{1+t^2}dt,\\
\sin x&=\displaystyle\frac{2t}{1+t^2}, \quad \cos x=\displaystyle\frac{1-t^2}{1+t^2}.\end{aligned}$$

In some cases one can use simpler substitutions $t=\tan x$, $t=\sin x$ or $t=\cos x$.
"
...
# ╔═╡ a139c5f5-0214-4685-85dd-461c98463d75
md"
## Area under a curve

Area between the functions $f$ and $g$, from $x=a$ to $x=b$ is given by

	
$$
\int\limits_a^b (f(x)-g(x))\,dx.$$

Parts of the area where $f\geq g$ are counted positively, while parts of the area where $f\lt g$ are counted negatively.
"

# ╔═╡ e4263a44-ac1a-4f1e-8b0e-0bcb3e08f39b
# Area between the sine function and the x-axis from 0 to π
integrate(sin(x),(x,0,PI))

# ╔═╡ 9f16a017-4e09-4cad-a801-e7f234505833
plot(sin(x),xlims=(0,pi),aspect_ratio=1)

# ╔═╡ ee9100c2-ea05-494a-af6b-6ff3d8029ecd
# Are between the function f(x)=x^2 and the x-axis from 0 to 1
integrate(x^2,(x,0,1))

# ╔═╡ a443a270-add8-40d8-8e7b-d0fb2aa7aae7
g=x^2

# ╔═╡ e4ff3283-7a07-4ca6-b1aa-def442a7f6a9
plot(g,xlims=(0,1), aspect_ratio=1)

# ╔═╡ 5d291049-1e14-4a69-884d-2b037a6955e1
# Integral with infinite bound
integrate(exp(-x),(x,0,Inf))

# ╔═╡ aef85bef-d2e3-428b-8467-d8f448352e7f
plot(exp(-x),xlims=(0,10))

# ╔═╡ c2140c72-89fa-4c8a-b948-20855e6aafdc
md"
## Length of a curve

The length of a curve defined by the function $f(x)$ from $x=a$ to $x=b$ is given by 

$$
\int\limits_a^b \sqrt{1+(f'(x))^2}\,dx.$$
"

# ╔═╡ dfc22025-0a68-4c2b-8eef-c01dedce6cda
# Length of a sine function between 0 and π cannot be computed symbolicaly
integrate(√(1+cos(x)^2), (x,0,PI))

# ╔═╡ b332c73d-5bfa-4ea4-b899-65e3bc6567c3
# Length of a function f(x)=x^2 from 0 to 1
integrate(√(1+4x^2),(x,0,1))
...
manifest_format = "2.0"
project_hash = "358f3325197341dc8c8677c883402a10876b43b0"
