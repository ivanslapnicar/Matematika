...
# ╔═╡ 8b5a261a-9b2f-4d84-a3d8-ef34337de6d8
plotly()
...
begin
	...
	Base.:+(A::Tuple,B::Vector)=A+Tuple(B)
	Base.:-(A::Tuple, B::Tuple)=A.-B
	Base.:/(A::Tuple, B::Number)=A./B
	LinearAlgebra.:×(A::Tuple,B::Tuple)=×(collect(A),collect(B))
	LinearAlgebra.:×(A::Array,B::Tuple)=×(A,collect(B))
end
...
manifest_format = "2.0"
project_hash = "30c01a754be4157a8a7d438c8c023577eccfeca2"
